...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" id="left-menubar" style="height: 100%; min-height:0!important; overflow-x: hidden;">
        <a href="{{url('/admin')}}" class="brand-link" style="text-align: center">
            <span class="brand-text font-weight-light"><b>Babysitter Admin</b></span>
        </a>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('users.index') }}" class="nav-link @if($menu=='Users') active @endif">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('openIdentify') }}" class="nav-link @if($menu=='Identification') active @endif">
                            <i class="nav-icon fa fa-file-contract"></i>
                            <p>Manage Identification</p>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{ route('feedback.index') }}" class="nav-link @if($menu=='Feedback') active @endif">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('trigger.index') }}" class="nav-link @if($menu=='Trigger') active @endif">
                            <i class="nav-icon fa fa-list"></i>
                            <p>Trigger</p>
                        </a>
                    </li>
    ...
    <footer class="main-footer">
        <strong>Babysitter Admin</strong>
    </footer>
</div>
